...
elseif($error){
 ...
 echo$putih."[".$turkis."•".$putih."] Status : ".$ijo."sukses$putih || gold +$ijo".$gold.$t;
      ...
      sleep(1);
      echo$putih."[".$turkis."•".$putih."] ".$turkis."watching video vip";
      $m=0;$w=3;while($q<$w){
         $m++;
         sleep(1);
         echo $putih.".";
 ...
 $nik=$js["data"]["userMsg"]["nickname"];
  ...
  echo $putih."[".$ijo."•".$putih."] ".$turkis.substr($nik,0,8)." |] ";
            $token=substr($config[$i],7,-22);
            $meid=substr($config[$i],-16);
            $js=json_decode(video($token,$meid),true);
            $code=$js["code"];
            $msg=$js["msg"];
            ...
            if($code=="200"){
               echo $putih."[".$turkis."•".$putih."] Status : ".$ijo."sukses$putih || gold +$ijo".$gold."$putih || vip: $turkis".$vip.$t;
               $limit=0;
            }
            else{
         ...
         $q=0;
         sleep(1);
         echo$putih."[z] ".$ijo."sleep:$putih $sleep $ijo sec ".$ijo."loading ".$putih;
         while($q<5){$q++;
                     echo".";
                     sleep(1);
                    }
